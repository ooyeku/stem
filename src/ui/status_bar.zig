...
pub const StatusBar = struct {
    ...
    pub fn draw(
        ...
        const mode_style: vaxis.Cell.Style = switch (mode) {
            ...
            .file_explorer => theme.styles.mode.file_picker,
            .references_picker => theme.styles.mode.symbol_picker,
            .diagnostics_picker => theme.styles.mode.symbol_picker,
        ...
        const mode_text = switch (mode) {
            ...
            .file_picker => " OPEN ",
            .file_explorer => " FILES ",
            .references_picker => " REFS ",
            .diagnostics_picker => " DIAGS ",
